  ...
  return (
    ...
    >
      ...
      <div className="space-y-8">
        <div>
          <h3 className="text-lg font-semibold mb-3">公司地址</h3>
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-700">科技园区88号</p>
              <p className="text-gray-700">创新大厦A座15层</p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex items-start">
            ...
            <div>
              <p className="text-gray-700">contact@treedeep.cn</p>
              <p className="text-gray-700">support@treedeep.cn</p>
            </div>
          </div>
        </div>

        <div>
          <h3 className="text-lg font-semibold mb-3">社交媒体</h3>
      ...
      <div className="mt-10">
        ...
        <table className="w-full text-gray-700">
          <tbody>
            <tr>
              <td className="py-2">周一至周五:</td>
              <td className="py-2">9:00 - 18:00</td>
            </tr>
            <tr>
              <td className="py-2">周六:</td>
              <td className="py-2">10:00 - 16:00</td>
            </tr>
            <tr>
              <td className="py-2">周日:</td>
              <td className="py-2">休息</td>
            </tr>
          </tbody>
        </table>
      </div>
