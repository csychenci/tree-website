    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          >
            <h3 className="text-xl font-bold mb-4">TreeDeep</h3>
            <p className="text-gray-400 mb-4">
              专业的软件开发服务提供商，致力于为企业提供高质量的数字化解决方案。
            </p>
          ...
          >
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services#miniprogram" className="text-gray-400 hover:text-white transition-colors">
                  小程序开发
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/services#app" className="text-gray-400 hover:text-white transition-colors">
                  APP开发
                </Link>
              </li>
              <li>
                <Link href="/services#admin" className="text-gray-400 hover:text-white transition-colors">
                  后台管理系统
                </Link>
              </li>
            </ul>
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">contact@treedeep.cn</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-gray-400 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          <p>&copy; {currentYear} TreeDeep 科技有限公司. 保留所有权利.</p>
        </motion.div>
      </div>
    </footer>
  );
